...
\newcommand{\zon}[2]{\mathcal{Z}\rb{#1,#2}} % zonotope
...
\newcommand{\taylor}[3]{\gamma\rb{#1,#2,#3}} % taylor error
...
\newcommand{\iz}[3]{\mathcal{Z}\rb{#1,#2,#3}} % interval zonotope
