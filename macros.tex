...
\newcommand{\diag}[1]{\operatorname{diag}\rb{#1}} % diagonal matrix
...
\newcommand{\dopt}[1]{\operatorname*{Opt}\rb{#1}} % set of optimum division vectors
...
\newcommand{\flowproj}[1]{Y_{#1}}  % flowpipe projection map
\newcommand{\project}[2]{Q\rb{#1,#2}} % projection bound of interval zonotope
