...
+ (\imag{z})^2}^{1/2}$.  
%% For two reals $r$ and $s$, the result of
...
= \sup\set{\abs{x_1},...,\abs{x_n}}$.  For $r\in\reals_{> 0}$ \is{This symbol has not been introduced before.} and
$x\in\reals^n$, we define the box of width $r$ around $x$ as
$\ball{x}{r} = \set{ x\in\reals^n: \norm{x}_\infty \leq r }$.
\is{This definition is incorrect.}
%
