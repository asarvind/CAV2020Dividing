...
quantity for a user chosen normalization error $\rho\in\reals^n_{>0}$.
%
\begin{align*}
...
= \taylor{f}{\Omega}{U}$ as the normalization error for splitting.  Using the
...
Besides, it is not known how to choose a normalization error $\rho$ for good
flowpipe accuracy.
