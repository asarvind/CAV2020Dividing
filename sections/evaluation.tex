...
\begin{table}
\begin{center}
\caption{Computation times \is{The times for IoU look odd. Should it not be the case that the time should increase with the increase in $\eta$?}}\label{tab:comptimes}
