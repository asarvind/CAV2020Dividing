...
$ g = 9.81, m = 1093.3, \mu = 1.0489, l_f = 1.156, l_r = 1.422, h_{cg}
  = 0.574, I_z = 1791.6, C_{Sf} = 20.89, C_{Sr} = 20.89, r = 4$ \is{Worth mentioning that the inputs are in SI}.  We
...
\is{It would have been good to mention the control goal here.}
...
\emph{Results:}  Our IoU method for each of the $8$, $16$ and $32$ divisions per
  ...
  \is{Computation times may be misleading, as different algorithms are running on different machines. However, it is a good information.}
%
\begin{figure}
